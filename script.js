...
var createScene = function () {
    ...
    for (i=0;i<4;i++) {
        var wall = BABYLON.MeshBuilder.CreateBox("wall", {width:30, height:50, depth:0.5}, scene);
    ...
    BABYLON.SceneLoader.ImportMesh("", "", "LittlestTokyo.babylon", scene, function (meshes) {
        for (mesh of meshes){
                mesh.scaling = new BABYLON.Vector3(0.05, 0.05, 0.05);
                mesh.position.y = 15;
                mesh.physicsImpostor = new BABYLON.PhysicsImpostor(mesh, BABYLON.PhysicsImpostor.MeshImpostor, {mass:0,restitution:0.3}, scene);
